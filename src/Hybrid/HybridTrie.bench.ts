...
Deno.bench(
  "HybridTrie (generally negative) search in trie of 100 words",
  () => {
...
Deno.bench(
  "HybridTrie (generally negative) search in trie of 500 words",
  () => {
...
Deno.bench(
  "HybridTrie (generally negative) search in trie of 1000 words",
  () => {
...
Deno.bench(
  "HybridTrie (generally negative) search in trie of 5000 words",
  () => {
...
Deno.bench(
  "HybridTrie (generally negative) search in trie of 10000 words",
  () => {
...
Deno.bench(
  "HybridTrie (generally negative) search in trie of 20000 words",
  () => {
...
Deno.bench(
  "HybridTrie (generally negative) search in trie of 32861 words",
  () => {
